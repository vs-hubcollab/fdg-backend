...
@app.route("/api/infos_gen", methods=["GET"])
def infos_gen():
...
# dans la sidebar
@app.route("/api/disparite_target", methods=["GET"])
...
@app.route("/api/infos_client", methods=["GET"])
def infos_client():
...
@app.route("/api/load_age_population", methods=["GET"])
...
# situant l'age du client
@app.route("/api/load_revenus_population", methods=["GET"])
...
@app.route("/api/load_voisins", methods=["GET"])
def load_voisins():
